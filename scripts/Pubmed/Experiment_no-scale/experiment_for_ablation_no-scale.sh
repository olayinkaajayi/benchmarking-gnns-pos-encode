...
function run_experiments {
  ...
  config_file_mod="$home/scripts/WikiCS/modified_config_$eta.json"
...
for eta in "${etas[@]}"; do
  tmux send-keys -t benchmark_COLLAB_edge_classification "rm $home/scripts/WikiCS/modified_config_$eta.json" C-m
done
